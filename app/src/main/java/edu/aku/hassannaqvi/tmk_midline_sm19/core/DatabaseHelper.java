package edu.aku.hassannaqvi.tmk_midline_sm19.core;
...
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.AreasContract;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.AreasContract.singleAreas;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.BLRandomContract;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.BLRandomContract.singleChild;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.DeceasedChildContract;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.DeceasedChildContract.DeceasedChild;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.DeceasedMotherContract;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.DeceasedMotherContract.DeceasedMother;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.FamilyMembersContract;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.FamilyMembersContract.familyMembers;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.FormsContract;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.FormsContract.FormsTable;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.MWRAContract;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.MWRAContract.MWRATable;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.SectionIIMContract;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.TalukasContract;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.TalukasContract.singleTalukas;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.UCsContract;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.UCsContract.singleUCs;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.UsersContract;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.UsersContract.singleUser;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.VillagesContract;
import edu.aku.hassannaqvi.tmk_midline_sm19.contracts.VillagesContract.singleVillages;
import edu.aku.hassannaqvi.tmk_midline_sm19.otherClasses.MotherLst;

import static edu.aku.hassannaqvi.tmk_midline_sm19.contracts.SectionIIMContract.singleIm;
...
//            + singleUser.REGION_DSS + " TEXT"
            + " );";
    public static final String DATABASE_NAME = "uentmkmidline_sm.db";
    public static final String DB_NAME = "uentmkmidline_sm_copy.db";
    public static final String PROJECT_NAME = "DMU-UENTMKMIDLINE_SM";

package edu.aku.hassannaqvi.tmk_midline_sm.core;
...
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.AreasContract;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.AreasContract.singleAreas;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.BLRandomContract;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.BLRandomContract.singleChild;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.DeceasedChildContract;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.DeceasedChildContract.DeceasedChild;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.DeceasedMotherContract;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.DeceasedMotherContract.DeceasedMother;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.FamilyMembersContract;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.FamilyMembersContract.familyMembers;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.FormsContract;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.FormsContract.FormsTable;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.MWRAContract;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.MWRAContract.MWRATable;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.SectionIIMContract;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.TalukasContract;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.TalukasContract.singleTalukas;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.UCsContract;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.UCsContract.singleUCs;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.UsersContract;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.UsersContract.singleUser;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.VillagesContract;
import edu.aku.hassannaqvi.tmk_midline_sm.contracts.VillagesContract.singleVillages;
import edu.aku.hassannaqvi.tmk_midline_sm.otherClasses.MotherLst;

import static edu.aku.hassannaqvi.tmk_midline_sm.contracts.SectionIIMContract.singleIm;

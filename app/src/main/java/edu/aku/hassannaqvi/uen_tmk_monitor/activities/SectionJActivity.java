...
//        sJ.put("tjchildSerial", childsMap.get(tj01.getSelectedItem().toString()).getSerialNo());
        ...
        sJ.put("tj01", tj01.getText().toString());
...
//        01
       /* if (tj01.getSelectedItem() == "....") {
        ...
        if (tj01.getText().toString().isEmpty()) {
            Toast.makeText(this, "ERROR(empty): " + getString(R.string.tj01), Toast.LENGTH_SHORT).show();
            tj01.setError("This data is Required! ");    // Set Error on last radio button
            tj01.requestFocus();
            Log.i(TAG, "tj01: This data is Required!");
            return false;
        } else {
...
//        13
        ...
        if (tj13a.isChecked()) {
            ...
            if (Long.valueOf(tj13m.getText().toString()) > 11 || Long.valueOf(tj13m.getText().toString()) < 1) {
                Toast.makeText(this, "ERROR(Invalid): " + getString(R.string.month), Toast.LENGTH_SHORT).show();

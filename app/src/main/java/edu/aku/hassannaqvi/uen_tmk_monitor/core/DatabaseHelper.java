package edu.aku.hassannaqvi.uen_tmk_monitor.core;
...
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.AreasContract;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.AreasContract.singleAreas;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.BLRandomContract;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.BLRandomContract.singleChild;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.DeceasedChildContract;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.DeceasedChildContract.DeceasedChild;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.DeceasedMotherContract;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.DeceasedMotherContract.DeceasedMother;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.FamilyMembersContract;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.FamilyMembersContract.familyMembers;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.FormsContract;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.FormsContract.FormsTable;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.MWRAContract;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.MWRAContract.MWRATable;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.SectionIIMContract;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.TalukasContract;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.TalukasContract.singleTalukas;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.UCsContract;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.UCsContract.singleUCs;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.UsersContract;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.UsersContract.singleUser;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.VillagesContract;
import edu.aku.hassannaqvi.uen_tmk_monitor.contracts.VillagesContract.singleVillages;
import edu.aku.hassannaqvi.uen_tmk_monitor.otherClasses.MotherLst;

import static edu.aku.hassannaqvi.uen_tmk_monitor.contracts.SectionIIMContract.singleIm;
...
//            + singleUser.REGION_DSS + " TEXT"
            + " );";
    public static final String DATABASE_NAME = "uentmk_monitor.db";
    public static final String DB_NAME = "uentmk_monitor_copy.db";

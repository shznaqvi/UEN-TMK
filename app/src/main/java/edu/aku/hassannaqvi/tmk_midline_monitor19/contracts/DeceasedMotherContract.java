package edu.aku.hassannaqvi.tmk_midline_monitor19.contracts;
...
public class DeceasedMotherContract {
    ...
    private final String projectName = "UEN-TMK-MIDLINE-MONITOR";
    private String _ID = "";
    private String _UID = "";
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        json.put(DeceasedMother.COLUMN_PROJECT_NAME, this.projectName == null ? JSONObject.NULL : this.projectName);
    ...
    public static abstract class DeceasedMother implements BaseColumns {
        ...
        public static String _URL = "deceasedmothermonitor.php";
    }

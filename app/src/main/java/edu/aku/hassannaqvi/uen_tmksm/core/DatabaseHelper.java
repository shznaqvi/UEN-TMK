package edu.aku.hassannaqvi.uen_tmksm.core;
...
import edu.aku.hassannaqvi.uen_tmksm.contracts.AreasContract;
import edu.aku.hassannaqvi.uen_tmksm.contracts.AreasContract.singleAreas;
import edu.aku.hassannaqvi.uen_tmksm.contracts.BLRandomContract;
import edu.aku.hassannaqvi.uen_tmksm.contracts.BLRandomContract.singleChild;
import edu.aku.hassannaqvi.uen_tmksm.contracts.DeceasedChildContract;
import edu.aku.hassannaqvi.uen_tmksm.contracts.DeceasedChildContract.DeceasedChild;
import edu.aku.hassannaqvi.uen_tmksm.contracts.DeceasedMotherContract;
import edu.aku.hassannaqvi.uen_tmksm.contracts.DeceasedMotherContract.DeceasedMother;
import edu.aku.hassannaqvi.uen_tmksm.contracts.FamilyMembersContract;
import edu.aku.hassannaqvi.uen_tmksm.contracts.FamilyMembersContract.familyMembers;
import edu.aku.hassannaqvi.uen_tmksm.contracts.FormsContract;
import edu.aku.hassannaqvi.uen_tmksm.contracts.FormsContract.FormsTable;
import edu.aku.hassannaqvi.uen_tmksm.contracts.MWRAContract;
import edu.aku.hassannaqvi.uen_tmksm.contracts.MWRAContract.MWRATable;
import edu.aku.hassannaqvi.uen_tmksm.contracts.SectionIIMContract;
import edu.aku.hassannaqvi.uen_tmksm.contracts.TalukasContract;
import edu.aku.hassannaqvi.uen_tmksm.contracts.TalukasContract.singleTalukas;
import edu.aku.hassannaqvi.uen_tmksm.contracts.UCsContract;
import edu.aku.hassannaqvi.uen_tmksm.contracts.UCsContract.singleUCs;
import edu.aku.hassannaqvi.uen_tmksm.contracts.UsersContract;
import edu.aku.hassannaqvi.uen_tmksm.contracts.UsersContract.singleUser;
import edu.aku.hassannaqvi.uen_tmksm.contracts.VillagesContract;
import edu.aku.hassannaqvi.uen_tmksm.contracts.VillagesContract.singleVillages;
import edu.aku.hassannaqvi.uen_tmksm.otherClasses.MotherLst;

import static edu.aku.hassannaqvi.uen_tmksm.contracts.SectionIIMContract.singleIm;
